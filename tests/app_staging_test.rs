...
fn make_base_app(
    ...
    App {
        ...
        merged_branch_fetch: keifu::merged_branch_fetch::MergedBranchFetch::new(),
        last_pull: None,
        pre_pull_head: None,
        ...
        merged_classify: keifu::merged_branch_fetch::MergedClassifier::new(),
        hide_merged_branches: false,
        base_update_merges: keifu::signature_guarded::SignatureGuarded::default(),
