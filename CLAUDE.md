...
- All-key keyboard enhancement must also request alternate keys; normalize its alternate and base-plus-Shift ASCII forms at the keybinding boundary so shifted bindings and editor text preserve the user’s layout-correct character.
