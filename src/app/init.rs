...
impl App {
    ...
    fn build(
        ...
        super::rebase_plan_actions::reconcile_interactive_rebase_state(repo.repo().path());
        ...
        let mut app = Self {
            ...
            open_prs_loaded: false,
            pr_repo_info: None,
            pr_repo_fetch: crate::pr::repo_info_fetch(),
