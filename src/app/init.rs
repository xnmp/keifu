...
impl App {
    ...
    fn build(
        ...
        Ok(Self {
            ...
            merged_branch_fetch: crate::merged_branch_fetch::MergedBranchFetch::new(),
            last_pull: None,
            pre_pull_head: None,
            ...
            merged_branches,
            merged_classify: crate::merged_branch_fetch::MergedClassifier::new(),
            hide_merged_branches: ui_state.hide_merged_branches,
            base_update_merges: crate::signature_guarded::SignatureGuarded::default(),
