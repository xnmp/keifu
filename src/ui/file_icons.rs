...
const DEFAULT: FileIcon = FileIcon {
    icon: "\u{f15b}",
    color: Color::Gray,
}; //
...
fn by_filename(name: &str) -> Option<FileIcon> {
    Some(match name.to_lowercase().as_str() {
        ...
        "docker-compose.yml" | "docker-compose.yaml" => FileIcon {
            icon: "\u{f308}",
            color: Color::Blue,
        },
        ...
        ".env" | ".env.local" | ".env.example" => FileIcon {
            icon: "\u{f462}",
            color: Color::Yellow,
        },
        ...
        "license" | "license.md" | "license.txt" => FileIcon {
            icon: "\u{f718}",
            color: Color::Yellow,
        },
        "flake.nix" => FileIcon {
...
fn by_extension(ext: &str) -> Option<FileIcon> {
    Some(match ext.to_lowercase().as_str() {
        ...
        // Images
        "png" | "jpg" | "jpeg" | "gif" | "bmp" | "ico" | "webp" | "avif" => FileIcon {
            icon: "\u{f1c5}",
            color: Color::Magenta,
        },
        "svg" => FileIcon {
